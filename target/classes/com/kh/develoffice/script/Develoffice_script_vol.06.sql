...
COMMENT ON COLUMN "WIDGET"."COORD_X" IS 'X좌표';

COMMENT ON COLUMN "WIDGET"."COORD_Y" IS 'Y좌표';
...
INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL,'전재광','1234','M','19850610',1,1,'01048992851','masta_jk@naver.com',
							'경기도 광명시 철산동',10000000,'01048992851','0',TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT);

INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL,'김상윤','1234','M','19901026',2,2,'01089819256','sangyoon5_4@naver.com',
							'경기도 성남시 수정구',8000000,'01089819256','0',TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT);
...
INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL,'유현규','1234','M','19950712',5,5,'01092600714','yhg8484@naver.com',
							'경기도 성남시 중원구',5000000,'01092600714','0',TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT);
