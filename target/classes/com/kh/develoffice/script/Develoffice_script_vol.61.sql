...
AS
SELECT TB_NO,TB_TITLE,TB_WRITER,EMP_NAME AS EMPNAME,TB_CONTENT,TB_ORIGINAL_FILENAME,TB_RENAME_FILENAME,TB_COUNT,TB_CREATE_DATE,TB_MODIFY_DATE,T.STATUS
FROM TEAM_BOARD T, EMPLOYEE E
WHERE T.TB_WRITER = E.EMP_ID;
...
AS
SELECT NOTICE_NO,NOTICE_TITLE,NOTICE_WRITER,EMP_NAME AS EMPNAME,NOTICE_CONTENT,NOTICE_ORIGINAL_FILENAME,NOTICE_RENAME_FILENAME,NOTICE_COUNT,NOTICE_CREATE_DATE,NOTICE_MODIFY_DATE,N.STATUS
FROM NOTICE N, EMPLOYEE E
WHERE N.NOTICE_WRITER = E.EMP_ID;
