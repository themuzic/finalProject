...
SELECT MSG_ID, CHAT_ID, M.EMP_ID, EMP_NAME, JOB_NAME, PROFILE_PATH, M_CONTENT, M_CREATE_DATE, M_STATUS
FROM MESSAGE M
...
-- 전자결재 테이블 뷰
CREATE OR REPLACE VIEW DOCU AS
SELECT D.*,EMP_NAME, JOB_NAME, DEPT_NAME
FROM DOCUMENT D
