...
CREATE TABLE "SCHEDULE" (
	...
	"BACK_COLOR"	VARCHAR2(20)	NOT NULL,
...
ALTER TABLE "PROJECT_TASK" ADD CONSTRAINT "FK_PROJECT_MEMBER_TO_PROJECT_TASK_1" FOREIGN KEY ("P_NO")
REFERENCES "PROJECT_MEMBER" ("P_NO");

ALTER TABLE "PROJECT_TASK" ADD CONSTRAINT "FK_PROJECT_MEMBER_TO_PROJECT_TASK_2" FOREIGN KEY ("TASK_WRITER")
REFERENCES "PROJECT_MEMBER" ("EMP_ID");
