...
--ALTER TABLE "PROJECT_TASK" ADD CONSTRAINT "PROJECT_MEMBER_TO_PROJECT_TASK_1" FOREIGN KEY ("P_NO")
--REFERENCES "PROJECT_MEMBER" ("P_NO");

--ALTER TABLE "PROJECT_TASK" ADD CONSTRAINT "PROJECT_MEMBER_TO_PROJECT_TASK_2" FOREIGN KEY ("TASK_WRITER")
