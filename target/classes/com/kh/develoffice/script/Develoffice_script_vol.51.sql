...
CREATE TABLE "SCHEDULE" (
    ...
    "S_PLAN"        VARCHAR2(1)     CHECK(S_PLAN IN('T','C'))
);
...
INSERT INTO JOIN_CHAT VALUES(CHAT_SEQ.CURRVAL, '전재광 대표', DEFAULT, DEFAULT, 10004, DEFAULT, DEFAULT, FN_KO_CHAR('전재광 대표'));
INSERT INTO JOIN_CHAT VALUES(CHAT_SEQ.CURRVAL, '유현규 사원', DEFAULT, DEFAULT, 10001, DEFAULT, DEFAULT, FN_KO_CHAR('유현규 사원'));
...
INSERT INTO JOIN_CHAT VALUES(CHAT_SEQ.CURRVAL, '전재광 대표, 김상윤 이사', DEFAULT, DEFAULT, 10004, DEFAULT, DEFAULT, FN_KO_CHAR('전재광 대표, 김상윤 이사'));
INSERT INTO JOIN_CHAT VALUES(CHAT_SEQ.CURRVAL, '김상윤 이사, 유현규 사원', DEFAULT, DEFAULT, 10001, DEFAULT, DEFAULT, FN_KO_CHAR('김상윤 이사, 유현규 사원'));
INSERT INTO JOIN_CHAT VALUES(CHAT_SEQ.CURRVAL, '전재광 대표, 유현규 사원', DEFAULT, DEFAULT, 10002, DEFAULT, DEFAULT, FN_KO_CHAR('전재광 대표, 유현규 사원'));
...
INSERT INTO MESSAGE VALUES(MSG_SEQ.NEXTVAL, CHAT_SEQ.CURRVAL, 10004, '<b>유현규 사원</b>님이 <b>전재광 대표</b>님, <b>김상윤 이사</b>님을 초대하셨습니다.', SYSDATE, 'Y', 2);
