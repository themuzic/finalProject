		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<form class="ui form uploadForm" id="uploadForm" enctype="multipart/form-data" method="post">
					  <div class="field">
					    <label style="font-size:15px;">제목</label>
					    <input type="text" name="first-name" placeholder="제목">
					  </div>
					  <div class="field">
					  ...
					  <button class="ui button" style="float:left;font-size:15px;">
						  취소
					  </button>
