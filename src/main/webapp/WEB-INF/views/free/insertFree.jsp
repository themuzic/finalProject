...
<body>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<form action="finsert.do" class="ui form uploadForm" id="uploadForm" enctype="multipart/form-data" method="post">
					  <div class="field">
					    <label style="font-size:15px;">제목</label>
					    <input type="text" name="frTitle" placeholder="제목">
					  </div>
					  <div class="field">
					    <label style="font-size:15px;">내용</label>
					    <textarea id="summernote" name="frContent"></textarea>
					  </div>
	...
	<script>
		    ...
		    function addFileList(fileIndex, fileName, fileSize, files){
		        ...
		        html +=	"       <input type='file' name='fUploadFile' class='test' multiple='multiple'>"
		        html += "    </td>"
		        html += "</tr>"
