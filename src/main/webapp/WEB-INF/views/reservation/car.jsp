													...
													<td style="border-bottom:none;">
														<table class="rs-resource-tbl" no="5109">
															<thead class="rs-view booking_resource_img_top">
																<tr><th scope="col"><span class="resource_name_span" title="차량" style="text-align: center;">차량</span> <span class="show-rs-info category_detail_view" r_type="R" no="5109">i</span></th></tr>
