													...
													<td style="border-bottom:none;">
														<table class="rs-resource-tbl" no="5109">
															<thead class="rs-view booking_resource_img_top">
																<tr><th scope="col"><span class="resource_name_span" title="안마의자" style="text-align: center;">안마의자</span></th></tr>
							...
							<form id="booking_resource_frm">
								...
								<div class="to-add detail-search">
									<dl class="after">
										...
										<dd>
											<input type="text" name="reservType" id="resource_list_select" style="width:270px" value="안마의자" readonly>
