		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<button class="large ui button btn-lg" type="submit" style="margin:0 0 5px 0; background-color:#5cb85c; color:white; font-size: 1.2rem;">
