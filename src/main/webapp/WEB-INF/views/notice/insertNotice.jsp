...
<body>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<div id="essential-write">
						필수 사항 작성
					</div>
					<hr>
					
					
					<form action="ninsert.do" class="ui form uploadForm" id="uploadForm" enctype="multipart/form-data" method="post">
					  <div class="field">
					    <label style="font-size:15px;">제목</label>
					    <input type="text" name="noTitle" placeholder="제목" style="font-size: 16px;">
					  </div>
					  <div class="field">
					    <label style="font-size:15px;">내용</label>
					    <textarea id="summernote" name="noContent"></textarea>
					  </div>
					 
					  <input type="hidden" name="noWriter" value="${loginUser.empId}">
					  ...
					  <button type="button" onclick="location.href='listNotice.do';" class="ui button" style="float:left;font-size:15px;">
						  취소
					  </button>
	...
	<script>
		    ...
		    // 업로드 파일 목록 생성
		    function addFileList(fileIndex, fileName, fileSize, files){
		        var html = "";
		        html += "<tr id='fileTr_" + fileIndex + "'>";
		        html += "    <td class='left' >";
		        html +=         fileName + " / " + fileSize + "MB "  + "&nbsp;<a href='#' onclick='deleteFile(" + fileIndex + "); return false;' class='btn small bg_02' style='box-shadow:none; border:1px solid #ececec;'>삭제</a>"
		        html +=	"       <input type='file' name='nUploadFile' class='test' multiple='multiple'>"
		        html += "    </td>"
		        html += "</tr>"
