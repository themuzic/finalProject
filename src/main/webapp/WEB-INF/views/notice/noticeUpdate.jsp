		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<form action="noticeUpdate.do" class="ui form uploadForm" id="uploadForm" enctype="multipart/form-data" method="post">
					  <div class="field">
					    <label style="font-size:15px;">제목</label>
					    <input type="text" name="noTitle" placeholder="제목" value="${n.noTitle}">
					  </div>
					  <div class="field">
					    <label style="font-size:15px;">내용</label>
					    <textarea id="summernote" name="noContent">${n.noContent}</textarea>
					  </div>
					  <input type="hidden" name="noId" value="${n.noId}">
					                ...
					                <tr id="fileTr_0">    
					                	<td class="left">
					                		<c:if test="${!empty n.originalFileName }">
					                				...
					                				<input type='file' name='noReloadFile' class='test1' style="display:none">
					                		</c:if>
					                	</td>
					                </tr>
					            </tbody>
			...
			$(function(){
	         ...
	         // 파일 리스트 번호
	          ...
	          function addFileList(fIndex, fileName, fileSize, files){
	              ...
	              html +=   "       <input type='file' name='noReloadFile' class='test1'>"
	              html += "    </td>"
	              html += "</tr>"
