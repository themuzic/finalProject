...
<body>
				...
				<div class="container-fluid">
					...
					<form action="tbinsert.do" class="ui form uploadForm" id="uploadForm" enctype="multipart/form-data" method="post">
					  <div class="field">
					    ...
					    <input type="text" name="tbTitle" placeholder="제목">
					  </div>
					  <div class="field">
					    <label style="font-size:15px;">내용</label>
					    <textarea id="summernote" name="tbContent"></textarea>
					  </div>
					  ...
					  <button type="button" onclick="location.href='listTeamBoard.do';" class="ui button" style="float:left;font-size:15px;">
						  취소
					  </button>
	...
	<script>
		    ...
		    function addFileList(fileIndex, fileName, fileSize, files){
		        ...
		        html +=	"       <input type='file' name='tbUploadFile' class='test' multiple='multiple'>"
		        html += "    </td>"
		        html += "</tr>"
