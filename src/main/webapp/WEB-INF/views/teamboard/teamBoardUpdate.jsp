		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<form action="teamBoardUpdate.do" class="ui form uploadForm" id="uploadForm" enctype="multipart/form-data" method="post">
					  <div class="field">
					    <label style="font-size:15px;">제목</label>
					    <input type="text" name="tbTitle" placeholder="제목" value="${tb.tbTitle}">
					  </div>
					  <div class="field">
					    <label style="font-size:15px;">내용</label>
					    <textarea id="summernote" name="tbContent">${tb.tbContent}</textarea>
					  </div>
					  <input type="hidden" name="tbId" value="${tb.tbId }">
					  <input type="hidden" name="tbWriter" value="${loginUser.empId}">
					  <input type="hidden" name="originalFileName" value="${tb.originalFileName }">
					  <input type="hidden" name="renameFileName" value="${tb.renameFileName }"> 
					  <div class="filezone">
					                ...
					                <tr id="fileTr_0">    
					                	<td class="left">
					                		<c:if test="${!empty tb.originalFileName }">
					                				...
					                				<input type='file' name='tbReloadFile' class='test1' style="display:none">
					                		</c:if>
					                	</td>
					                </tr>
					            </tbody>
					  ...
					  <button type="button" onclick="location.href='teamBoardFree.do';" class="ui button" style="float:left;font-size:15px;">
						  취소
					  </button>
			...
			$(function(){
	         ...
	         // 파일 리스트 번호
	          ...
	          function addFileList(fIndex, fileName, fileSize, files){
	              ...
	              html +=   "       <input type='file' name='tbReloadFile' class='test1'>"
	              html += "    </td>"
	              html += "</tr>"
