...
CREATE TABLE "SCHEDULE" (
	...
	"BACK_COLOR"	VARCHAR2(200)	NOT NULL,
...
select all_day, emp_name, s_title, start_date, start_time, end_date, end_time, s_type, back_color, s_content
from schedule 
...
select s_no, start_date, start_time, end_date, end_time, emp_id, emp_name || ' ' || job_code as emp_name, create_date, s_title, s_content, back_color, s_type, s_plan, dept_code, all_day
from schedule
join employee using(emp_id)
join job using(job_code)
where status='Y';
