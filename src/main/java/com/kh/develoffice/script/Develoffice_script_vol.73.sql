...
COMMENT ON COLUMN "EMPLOYEE"."VACATION" IS '남은연차일수';
...
CREATE TABLE "PROJECT" (
	...
	"P_PROGRESS"	NUMBER	DEFAULT 0	NULL,
...
CREATE TABLE "NOTICE" (
	...
	"NOTICE_ORIGINAL_FILENAME" VARCHAR2(100),
   	"NOTICE_RENAME_FILENAME" VARCHAR2(100),	
...
COMMENT ON COLUMN "NOTICE"."NOTICE_ORIGINAL_FILENAME" IS '파일원본명';

COMMENT ON COLUMN "NOTICE"."NOTICE_RENAME_FILENAME" IS '파일수정명';

COMMENT ON COLUMN "NOTICE"."NOTICE_COUNT" IS '조회수';

COMMENT ON COLUMN "NOTICE"."NOTICE_CREATE_DATE" IS '게시일자';

COMMENT ON COLUMN "NOTICE"."NOTICE_MODIFY_DATE" IS '수정일';
...
COMMENT ON COLUMN "DOCUMENT"."TITLE" IS '문서제목';
...
COMMENT ON COLUMN "DOCUMENT"."MODIFY_DATE" IS '마지막으로 수정된 날짜';

COMMENT ON COLUMN "DOCUMENT"."STATUS" IS '문서의 현재 진행 상태';
...
CREATE TABLE "APPROVAL" (
	"AP_PK"				NUMBER		NOT NULL,
	"DOCU_NUM"			NUMBER		NOT NULL,
	"EMP_ID"			NUMBER		NOT NULL,
	"STATUS"			VARCHAR2(1)	DEFAULT 'N'	CHECK(STATUS IN('Y','N')),
	"APPROVAL_DATE"		DATE		NULL
);
COMMENT ON COLUMN "APPROVAL"."AP_PK" IS '결재선PK';

COMMENT ON COLUMN "APPROVAL"."DOCU_NUM" IS '통합문서FK';

COMMENT ON COLUMN "APPROVAL"."EMP_ID" IS '결재선에포함된직원FK';
...
CREATE TABLE "DOCUA" (
	...
	"ACCOUNT_NAME"		VARCHAR2(1000)	NOT NULL,
	"EXPENSE_DATE"		VARCHAR2(1000)	NOT NULL,
	"DEPARTMENT_NAME"	VARCHAR2(1000)	NOT NULL,
	"PRICE"				VARCHAR2(1000)	NOT NULL,
	"CUSTOMER"			VARCHAR2(1000)	NOT NULL,
...
CREATE TABLE "VACATION" (
	"DOCU_NUM"		NUMBER			NOT NULL,
	"VACATION_TYPE"	VARCHAR2(3)		NOT NULL,
	"VACATION_NAME"	VARCHAR2(10)	NOT NULL,
...
COMMENT ON COLUMN "VACATION"."DOCU_NUM" IS '통합문서PK';

COMMENT ON COLUMN "VACATION"."VACATION_TYPE" IS '휴가타입';

COMMENT ON COLUMN "VACATION"."VACATION_NAME" IS '휴가종류';

COMMENT ON COLUMN "VACATION"."START_DATE" IS '시작날짜';

COMMENT ON COLUMN "VACATION"."END_DATE" IS '종료날짜';

COMMENT ON COLUMN "VACATION"."REASON" IS '사유';

COMMENT ON COLUMN "VACATION"."USE_DAY" IS '사용일';
...
COMMENT ON COLUMN "MESSAGE"."M_TYPE" IS '메세지 타입';
...
CREATE TABLE "TEAM_BOARD" (
    ...
    "TB_WRITER"	NUMBER	NOT NULL,
	"TB_CONTENT"	CLOB			NOT NULL,
    "TB_ORIGINAL_FILENAME" VARCHAR2(100),
    "TB_RENAME_FILENAME" VARCHAR2(100),
	"TB_COUNT"	NUMBER		    DEFAULT 0,
	"TB_CREATE_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"TB_MODIFY_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"STATUS"		VARCHAR2(2)	DEFAULT 'Y'	CHECK(STATUS IN('Y','N'))
);


COMMENT ON COLUMN "TEAM_BOARD"."TB_NO" IS '글번호';

COMMENT ON COLUMN "TEAM_BOARD"."TB_TITLE" IS '글제목';

COMMENT ON COLUMN "TEAM_BOARD"."TB_WRITER" IS '작성자';

COMMENT ON COLUMN "TEAM_BOARD"."TB_CONTENT" IS '글내용';

COMMENT ON COLUMN "TEAM_BOARD"."TB_ORIGINAL_FILENAME" IS '파일원본명';

COMMENT ON COLUMN "TEAM_BOARD"."TB_RENAME_FILENAME" IS '파일수정명';

COMMENT ON COLUMN "TEAM_BOARD"."TB_COUNT" IS '조회수';

COMMENT ON COLUMN "TEAM_BOARD"."TB_CREATE_DATE" IS '게시일';

COMMENT ON COLUMN "TEAM_BOARD"."TB_MODIFY_DATE" IS '수정일';
...
CREATE TABLE "TEAM_BOARD_REPLY" (
	"TB_RID"		NUMBER			NOT NULL,
	"REF_TID"		NUMBER			NOT NULL,
	"TB_RWRITER"	NUMBER			NOT NULL,
	"TB_RCONTENT"	VARCHAR2(400)	NULL,
	"TB_CREATE_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"TB_MODIFY_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"STATUS"		VARCHAR2(1)	DEFAULT 'Y'	CHECK(STATUS IN('Y','N'))
);

COMMENT ON COLUMN "TEAM_BOARD_REPLY"."TB_RID" IS '댓글번호';

COMMENT ON COLUMN "TEAM_BOARD_REPLY"."REF_TID" IS '글번호';

COMMENT ON COLUMN "TEAM_BOARD_REPLY"."TB_RWRITER" IS '작성자';

COMMENT ON COLUMN "TEAM_BOARD_REPLY"."TB_RCONTENT" IS '내용';

COMMENT ON COLUMN "TEAM_BOARD_REPLY"."TB_CREATE_DATE" IS '작성일';

COMMENT ON COLUMN "TEAM_BOARD_REPLY"."TB_MODIFY_DATE" IS '수정일';
...
CREATE TABLE "TODO_BOARD" (
    ...
    "TD_BOARD_COLOR"        VARCHAR2(20)    NULL,
...
COMMENT ON COLUMN "TODO_BOARD"."TD_BOARD_COLOR" IS '보드 색깔';
...
COMMENT ON COLUMN "MAIL_DEL"."MAIL_IMPORTANT" IS '중요메일';
...
CREATE TABLE "SCHEDULE" (
    ...
    "ALL_DAY"       VARCHAR2(1)     NULL,
	"S_TITLE"       VARCHAR2(1000)  NOT NULL,
    "S_CONTENT"     VARCHAR2(3000)  NULL,
    "S_TYPE"        VARCHAR2(100)   NOT NULL,
...
COMMENT ON COLUMN "SCHEDULE"."START_DATE" IS '시작날짜';

COMMENT ON COLUMN "SCHEDULE"."START_TIME" IS '시작시간';

COMMENT ON COLUMN "SCHEDULE"."END_DATE" IS '종료날짜';

COMMENT ON COLUMN "SCHEDULE"."END_TIME" IS '종료시간';

COMMENT ON COLUMN "SCHEDULE"."ALL_DAY" IS '하루종일';

COMMENT ON COLUMN "SCHEDULE"."S_TITLE" IS '일정명';

COMMENT ON COLUMN "SCHEDULE"."S_CONTENT" IS '일정내용';

COMMENT ON COLUMN "SCHEDULE"."S_TYPE" IS '일정타입';

COMMENT ON COLUMN "SCHEDULE"."CREATE_DATE" IS '등록시간';

COMMENT ON COLUMN "SCHEDULE"."STATUS" IS '상태';

COMMENT ON COLUMN "SCHEDULE"."S_PLAN" IS '개인/회사 일정';

----------------------------------------------------------

CREATE TABLE "PROJECT_REPLY" (
	"T_RID"	NUMBER		NOT NULL,
	"TASK_NO"	NUMBER		NOT NULL,
	"T_RWRITER"	NUMBER		NOT NULL,
	"T_RCONTENT"	VARCHAR2(500)		NULL,
	"CREATE_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"MODIFY_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"STATUS"		VARCHAR2(1)	DEFAULT 'Y'	CHECK(STATUS IN('Y','N'))
);

COMMENT ON COLUMN "PROJECT_REPLY"."T_RID" IS '프로젝트 TASK 댓글 번호';

COMMENT ON COLUMN "PROJECT_REPLY"."TASK_NO" IS '업무번호';

COMMENT ON COLUMN "PROJECT_REPLY"."T_RWRITER" IS '사번PK';

COMMENT ON COLUMN "PROJECT_REPLY"."T_RCONTENT" IS '댓글 내용';
...
CREATE TABLE "JOIN_CHAT" (
	...
	"NAME_STATUS"	VARCHAR2(1)	DEFAULT 'N'	NOT NULL,
	"CHAT_STATUS"	VARCHAR2(1)	DEFAULT	'Y'	NOT NULL,
	"ALARM_YN"	VARCHAR2(1)	DEFAULT	'Y'	NOT NULL,
	"EMP_ID"		NUMBER			NOT NULL,
...
COMMENT ON COLUMN "JOIN_CHAT"."NAME_STATUS" IS '이름 변경 여부';

COMMENT ON COLUMN "JOIN_CHAT"."CHAT_STATUS" IS '채팅방 삭제 여부';

COMMENT ON COLUMN "JOIN_CHAT"."ALARM_YN" IS '알람여부';
...
COMMENT ON COLUMN "HELP"."BRING_DATE" IS '대리업무할직원FK';

COMMENT ON COLUMN "HELP"."REASON" IS '사유';
...
COMMENT ON COLUMN "RETIRE"."DOCU_NUM" IS '통합문서PK';

COMMENT ON COLUMN "RETIRE"."ENROLL_DATE" IS '입사일';

COMMENT ON COLUMN "RETIRE"."RETIRE_DATE" IS '퇴사일';

COMMENT ON COLUMN "RETIRE"."REASON" IS '사유';
...
CREATE TABLE "PROJECT_TASK" (
	"TASK_NO"	NUMBER		NOT NULL,
	"P_NO"	NUMBER		NOT NULL,
	"TASK_WRITER"	NUMBER		NOT NULL,
	"TASK_TITLE"	VARCHAR2(1000)		NULL,
	"TASK_CONTENT"	VARCHAR2(1000)		NULL,
	"TASK_COUNT"	NUMBER	DEFAULT 0	NOT NULL,
	"STATUS"	VARCHAR2(2)	DEFAULT 'Y'	NOT NULL,
	"T_CREATE_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"T_MODIFY_DATE"	DATE	DEFAULT SYSDATE	NOT NULL,
	"T_ORIGINAL_FILENAME"	VARCHAR2(100)		NULL,
	"T_RENAME_FILENAME"	VARCHAR2(100)		NULL
);

COMMENT ON COLUMN "PROJECT_TASK"."TASK_NO" IS '업무번호';

COMMENT ON COLUMN "PROJECT_TASK"."P_NO" IS '프로젝트 번호';

COMMENT ON COLUMN "PROJECT_TASK"."TASK_WRITER" IS '사번PK';

COMMENT ON COLUMN "PROJECT_TASK"."TASK_TITLE" IS '업무 제목';

COMMENT ON COLUMN "PROJECT_TASK"."TASK_CONTENT" IS '업무 내용';

COMMENT ON COLUMN "PROJECT_TASK"."TASK_COUNT" IS '조회수';

COMMENT ON COLUMN "PROJECT_TASK"."STATUS" IS '상태';

COMMENT ON COLUMN "PROJECT_TASK"."T_CREATE_DATE" IS '등록일';

COMMENT ON COLUMN "PROJECT_TASK"."T_MODIFY_DATE" IS '수정일';

COMMENT ON COLUMN "PROJECT_TASK"."T_ORIGINAL_FILENAME" IS '원본파일명';

COMMENT ON COLUMN "PROJECT_TASK"."T_RENAME_FILENAME" IS '수정파일명';
...
ALTER TABLE "APPROVAL" ADD CONSTRAINT "PK_APPROVAL" PRIMARY KEY ("AP_PK");
...
ALTER TABLE "TEAM_BOARD" ADD CONSTRAINT "PK_TEAM_BOARD" PRIMARY KEY ("TB_NO");

ALTER TABLE "FREE_LIKE" ADD CONSTRAINT "PK_FREE_LIKE" PRIMARY KEY ("EMP_ID","FREE_NO");

ALTER TABLE "TEAM_BOARD_REPLY" ADD CONSTRAINT "PK_TEAM_BOARD_REPLY" PRIMARY KEY ("TB_RID");
...
ALTER TABLE "PROJECT_REPLY" ADD CONSTRAINT "PK_PROJECT_REPLY" PRIMARY KEY ("T_RID");
...
ALTER TABLE "VACATION" ADD CONSTRAINT "PK_VACATION" PRIMARY KEY ("DOCU_NUM");

ALTER TABLE "RETIRE" ADD CONSTRAINT "PK_RETIRE" PRIMARY KEY ("DOCU_NUM");

ALTER TABLE "PROJECT_TASK" ADD CONSTRAINT "PK_PROJECT_TASK" PRIMARY KEY ("TASK_NO");
...
ALTER TABLE "TODO" ADD CONSTRAINT "FK_EMPLOYEE_TO_TODO_1" FOREIGN KEY ("EMP_ID")
REFERENCES "EMPLOYEE" ("EMP_ID");

ALTER TABLE "NOTICE" ADD CONSTRAINT "FK_EMPLOYEE_TO_NOTICE_1" FOREIGN KEY ("NOTICE_WRITER")
REFERENCES "EMPLOYEE" ("EMP_ID");

ALTER TABLE "FREE_REPLY" ADD CONSTRAINT "FK_FREE_TO_FREE_RE_1" FOREIGN KEY ("REF_FID")
REFERENCES "FREE" ("FREE_NO");

ALTER TABLE "FREE_REPLY" ADD CONSTRAINT "FK_EMPLOYEE_TO_FREE_RE_2" FOREIGN KEY ("FREE_RWRITER")
REFERENCES "EMPLOYEE" ("EMP_ID");
...
ALTER TABLE "TEAM_BOARD" ADD CONSTRAINT "FK_EMPLOYEE_TO_TEAM_B_1" FOREIGN KEY ("TB_WRITER")
REFERENCES "EMPLOYEE" ("EMP_ID");                                                                       

ALTER TABLE "FREE_LIKE" ADD CONSTRAINT "FK_EMPLOYEE_TO_FREE_LIKE_1" FOREIGN KEY ("EMP_ID")
REFERENCES "EMPLOYEE" ("EMP_ID");

ALTER TABLE "FREE_LIKE" ADD CONSTRAINT "FK_FREE_TO_FREE_LIKE_1" FOREIGN KEY ("FREE_NO")
REFERENCES "FREE" ("FREE_NO");

ALTER TABLE "FREE" ADD CONSTRAINT "FK_EMPLOYEE_TO_FREE_1" FOREIGN KEY ("FREE_WRITER")
REFERENCES "EMPLOYEE" ("EMP_ID");                                                                          

ALTER TABLE "TEAM_BOARD_REPLY" ADD CONSTRAINT "FK_TEAM_B_TO_TEAM_B_RE_1" FOREIGN KEY ("REF_TID")
REFERENCES "TEAM_BOARD" ("TB_NO");

ALTER TABLE "TEAM_BOARD_REPLY" ADD CONSTRAINT "FK_TEAM_B_TO_TEAM_B_RE_2" FOREIGN KEY ("TB_RWRITER")
REFERENCES "EMPLOYEE" ("EMP_ID");

ALTER TABLE "TODO_BOARD" ADD CONSTRAINT "FK_EMP_TO_TODO_B_1" FOREIGN KEY ("EMP_ID")
REFERENCES "EMPLOYEE" ("EMP_ID");

ALTER TABLE "SCHEDULE" ADD CONSTRAINT "FK_EMP_TO_SCHE_1" FOREIGN KEY ("EMP_ID")
REFERENCES "EMPLOYEE" ("EMP_ID");

ALTER TABLE "PROJECT_REPLY" ADD CONSTRAINT "FK_TASK_TO_PROJECT_REPLY_1" FOREIGN KEY ("TASK_NO")
REFERENCES "PROJECT_TASK" ("TASK_NO");

ALTER TABLE "PROJECT_REPLY" ADD CONSTRAINT "FK_EMPLOYEE_TO_PROJECT_REPLY_1" FOREIGN KEY ("T_RWRITER")
REFERENCES "EMPLOYEE" ("EMP_ID");
...
ALTER TABLE "VACATION" ADD CONSTRAINT "FK_DOCUMENT_TO_VACATION_1" FOREIGN KEY ("DOCU_NUM")
REFERENCES "DOCUMENT" ("DOCU_NUM");

ALTER TABLE "RETIRE" ADD CONSTRAINT "FK_DOCUMENT_TO_RETIRE_1" FOREIGN KEY ("DOCU_NUM")
REFERENCES "DOCUMENT" ("DOCU_NUM");

ALTER TABLE "PROJECT_TASK" ADD CONSTRAINT "FK_PROJECT_TO_PROJECT_TASK_1" FOREIGN KEY ("P_NO")
REFERENCES "PROJECT" ("P_NO");

ALTER TABLE "PROJECT_TASK" ADD CONSTRAINT "FK_EMPLOYEE_TO_PROJECT_TASK_1" FOREIGN KEY ("TASK_WRITER")
REFERENCES "EMPLOYEE" ("EMP_ID");
...
INSERT INTO DEPARTMENT VALUES(2,'총무팀');
INSERT INTO DEPARTMENT VALUES(3,'인사팀');
INSERT INTO DEPARTMENT VALUES(4,'회계팀');
...
INSERT INTO JOB VALUES(5,'주임');
INSERT INTO JOB VALUES(6,'사원');
----------------------------------------------------------
...
INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL,'전재광','1234','M','19850610',1,1,'01048992851','kh.develoffice@gmail.com',
							'경기도 광명시 철산동',10000000,'01048992851','0',TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT, NULL, FN_KO_CHAR('전재광'),DEFAULT,DEFAULT);

INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL,'김상윤','1234','M','19901026',2,2,'01089819256','sangyoonsla@gmail.com',
							'경기도 성남시 수정구',8000000,'01089819256','0',TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT, NULL, FN_KO_CHAR('김상윤'),DEFAULT,DEFAULT);

INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL, '원영주', '1234', 'F', '19940331', 3, 4, '01031563212', 'kh.191105.end@gmail.com',
                            '강원도 춘천시 퇴계동', 7000000, '01031563212', '0', TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT, NULL, FN_KO_CHAR('원영주'),DEFAULT,DEFAULT);

INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL,'유현규','1234','M','19950712',5,3,'01092600714','yhg848484@gmail.com',
							'경기도 성남시 중원구',5000000,'01092600714','0',TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT, NULL, FN_KO_CHAR('유현규'),DEFAULT,DEFAULT);

INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL, '설용환', '1234', 'M', '19890214', 3, 3, '01083311011', 'dydghks11@naver.com',
                            '서울시 송파구 문정동', 5000000, '01083311011', '0', TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT, NULL, FN_KO_CHAR('설용환'),DEFAULT,DEFAULT);
...
INSERT INTO WIDGET VALUES(5,10001,25,625,'N','Y');
...
INSERT INTO WIDGET VALUES(5,10002,25,625,'N','Y');
...
INSERT INTO WIDGET VALUES(5,10003,25,625,'N','Y');
...
INSERT INTO WIDGET VALUES(5,10004,25,625,'N','Y');
...
INSERT INTO WIDGET VALUES(5,10005,25,625,'N','Y');
...
SELECT EMP_ID,EMP_NAME,EMP_PWD,GENDER,BIRTH,DEPT_CODE,DEPT_NAME,JOB_CODE,
       JOB_NAME,PHONE,EMAIL,ADDRESS,SALARY,ACCOUNT,STAR,TO_CHAR(ENROLL_DATE,'YYYY-MM-DD') ENROLL_DATE,TO_CHAR(RETIRE_DATE,'YYYY-MM-DD') RETIRE_DATE,
       EMP_STATUS,PROFILE_PATH,DIV_NAME,VACATION,WORK_STATUS,STATUS_MSG
FROM EMPLOYEE
...
SELECT J.CHAT_ID, J.EMP_ID, CHAT_NAME, C.CREATE_DATE, C.MODIFY_DATE "MODIFY_DATE", C.CHAT_TYPE,
	(SELECT M_CONTENT
	 ...
	 WHERE MSG_ID IN (SELECT MAX(MSG_ID)
              ...
              WHERE M_TYPE=1
			  GROUP BY CHAT_ID)
		AND CHAT_ID = J.CHAT_ID AND M_CREATE_DATE >= J.JOIN_DATE) AS "M_CONTENT",
	(SELECT COUNT(J2.CHAT_ID)
         ...
         (SELECT COUNT(*)
         FROM MESSAGE M2
         WHERE M2.CHAT_ID = J.CHAT_ID AND M2.M_CREATE_DATE > J.MODIFY_DATE AND M_CREATE_DATE<= C.MODIFY_DATE) "JOIN_COUNT",
         AUTO_NAME
FROM JOIN_CHAT J
...
from mail m
join mail_del d on(m.mail_num = d.mail_num)
...
INSERT INTO JOIN_CHAT VALUES(CHAT_SEQ.CURRVAL, '전재광 대표', DEFAULT, DEFAULT, DEFAULT, 10004, DEFAULT, DEFAULT, FN_KO_CHAR('전재광 대표'));
INSERT INTO JOIN_CHAT VALUES(CHAT_SEQ.CURRVAL, '유현규 사원', DEFAULT, DEFAULT, DEFAULT, 10001, DEFAULT, DEFAULT, FN_KO_CHAR('유현규 사원'));
INSERT INTO MESSAGE VALUES(MSG_SEQ.NEXTVAL, CHAT_SEQ.CURRVAL, 10004, '대표님 안녕하세요!', SYSDATE, 'Y', 1);
INSERT INTO MESSAGE VALUES(MSG_SEQ.NEXTVAL, CHAT_SEQ.CURRVAL, 10001, '그래요 현규씨 안녕하세요.', SYSDATE, 'Y', 1);
INSERT INTO CHAT VALUES(CHAT_SEQ.NEXTVAL, DEFAULT, SYSDATE, 'Y', 2);
INSERT INTO JOIN_CHAT VALUES(CHAT_SEQ.CURRVAL, '전재광 대표, 김상윤 이사', DEFAULT, DEFAULT, DEFAULT, 10004, DEFAULT, DEFAULT, FN_KO_CHAR('전재광 대표, 김상윤 이사'));
INSERT INTO JOIN_CHAT VALUES(CHAT_SEQ.CURRVAL, '김상윤 이사, 유현규 사원', DEFAULT, DEFAULT, DEFAULT, 10001, DEFAULT, DEFAULT, FN_KO_CHAR('김상윤 이사, 유현규 사원'));
INSERT INTO JOIN_CHAT VALUES(CHAT_SEQ.CURRVAL, '전재광 대표, 유현규 사원', DEFAULT, DEFAULT, DEFAULT, 10002, DEFAULT, DEFAULT, FN_KO_CHAR('전재광 대표, 유현규 사원'));
INSERT INTO MESSAGE VALUES(MSG_SEQ.NEXTVAL, CHAT_SEQ.CURRVAL, 10004, '여기가 거긴가요?', SYSDATE, 'Y', 1);
INSERT INTO MESSAGE VALUES(MSG_SEQ.NEXTVAL, CHAT_SEQ.CURRVAL, 10001, '응 맞아.', sysdate, 'Y', 1);
INSERT INTO MESSAGE VALUES(MSG_SEQ.NEXTVAL, CHAT_SEQ.CURRVAL, 10002, '대표님 커피 드시나요?', SYSDATE, 'Y', 1);


-- TO-DO BOARD 샘플 데이터
INSERT INTO TODO_BOARD VALUES(TODO_BOARD_SEQ.NEXTVAL, '4월 업무', 10003, '4월 업무ㅜㅜㅜㅜ', '#d9ead3', SYSDATE, SYSDATE, DEFAULT);
INSERT INTO TODO_BOARD VALUES(TODO_BOARD_SEQ.NEXTVAL, '5월 업무', 10003, '5월 업무ㅜㅜㅜㅜ', '#76a5af', SYSDATE, SYSDATE, DEFAULT);
INSERT INTO TODO_BOARD VALUES(TODO_BOARD_SEQ.NEXTVAL, '6월 업무', 10003, '6월 업무ㅜㅜㅜㅜ', '#073763', SYSDATE, SYSDATE, DEFAULT);
INSERT INTO TODO_BOARD VALUES(TODO_BOARD_SEQ.NEXTVAL, '7월 업무', 10003, '7월 업무ㅜㅜㅜㅜ', '#674ea7', SYSDATE, SYSDATE, DEFAULT);
INSERT INTO TODO_BOARD VALUES(TODO_BOARD_SEQ.NEXTVAL, '8월 업무', 10003, '8월 업무ㅜㅜㅜㅜ', '#f6b26b', SYSDATE, SYSDATE, DEFAULT);
...
AS
SELECT FREE_NO,FREE_TITLE,FREE_WRITER,EMP_NAME AS EMPNAME,FREE_CONTENT,F_ORIGINAL_FILENAME,F_RENAME_FILENAME,FREE_COUNT,TO_CHAR(F_CREATE_DATE,'yyyy-mm-dd hh24:mi:ss') F_CREATE_DATE,TO_CHAR(F_MODIFY_DATE,'yyyy-mm-dd hh24:mi:ss') F_MODIFY_DATE,F.STATUS,FREE_LIKE_COUNT
FROM FREE F, EMPLOYEE E
WHERE F.FREE_WRITER = E.EMP_ID;

CREATE OR REPLACE VIEW FREE_RE_DETAIL
AS
SELECT FREE_RID,REF_FID,FREE_RWRITER,EMP_NAME AS EMPNAME,FREE_RCONTENT,CREATE_DATE,MODIFY_DATE,R.STATUS
FROM FREE_REPLY R, EMPLOYEE E
WHERE R.FREE_RWRITER = E.EMP_ID;
...
AS
SELECT TB_NO,TB_TITLE,TB_WRITER,D.DEPT_CODE,EMP_NAME AS EMPNAME,TB_CONTENT,TB_ORIGINAL_FILENAME,TB_RENAME_FILENAME,TB_COUNT,TO_CHAR(TB_CREATE_DATE,'yyyy-mm-dd hh24:mi:ss') TB_CREATE_DATE,TO_CHAR(TB_MODIFY_DATE,'yyyy-mm-dd hh24:mi:ss') TB_MODIFY_DATE,T.STATUS
FROM TEAM_BOARD T, EMPLOYEE E, DEPARTMENT D
WHERE T.TB_WRITER = E.EMP_ID AND D.DEPT_CODE = E.DEPT_CODE;

CREATE OR REPLACE VIEW TEAM_BOARD_RE_DETAIL
AS
SELECT TB_RID,REF_TID,TB_RWRITER,EMP_NAME AS EMPNAME,TB_RCONTENT,TB_CREATE_DATE,TB_MODIFY_DATE,T.STATUS
...
AS
SELECT NOTICE_NO,NOTICE_TITLE,NOTICE_WRITER,D.DEPT_CODE,EMP_NAME AS EMPNAME,NOTICE_CONTENT,NOTICE_ORIGINAL_FILENAME,NOTICE_RENAME_FILENAME,NOTICE_COUNT,TO_CHAR(NOTICE_CREATE_DATE,'yyyy-mm-dd hh24:mi:ss') NOTICE_CREATE_DATE,TO_CHAR(NOTICE_MODIFY_DATE,'yyyy-mm-dd hh24:mi:ss') NOTICE_MODIFY_DATE,N.STATUS
