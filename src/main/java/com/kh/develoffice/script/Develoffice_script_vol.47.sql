...
INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL,'전재광','1234','M','19850610',1,1,'01048992851','masta_jk@naver.com',
							'경기도 광명시 철산동',10000000,'01048992851','0',TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT, NULL, FN_KO_CHAR('전재광'),DEFAULT);

INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL,'김상윤','1234','M','19901026',2,2,'01089819256','sangyoon2ya@gmail.com',
							'경기도 성남시 수정구',8000000,'01089819256','0',TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT, NULL, FN_KO_CHAR('김상윤'),DEFAULT);

INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL, '원영주', '1234', 'F', '19940331', 6, 4, '01031563212', 'oneyj33@naver.com',
                            '강원도 춘천시 퇴계동', 7000000, '01031563212', '0', TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT, NULL, FN_KO_CHAR('원영주'),DEFAULT);

INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL,'유현규','1234','M','19950712',5,5,'01092600714','sangyoon5_4@naver.com',
							'경기도 성남시 중원구',5000000,'01092600714','0',TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT, NULL, FN_KO_CHAR('유현규'),DEFAULT);

INSERT INTO EMPLOYEE VALUES(EMP_SEQ.NEXTVAL, '설용환', '1234', 'M', '19890214', 3, 3, '01083311011', 'dydghks11@naver.com',
                            '서울시 송파구 문정동', 5000000, '01083311011', '0', TO_DATE('20190415','YYYY-MM-DD'),NULL,DEFAULT,DEFAULT, NULL, FN_KO_CHAR('설용환'),DEFAULT);
...
SELECT EMP_ID,EMP_NAME,EMP_PWD,GENDER,BIRTH,DEPT_CODE,DEPT_NAME,JOB_CODE,
       ...
       EMP_STATUS,PROFILE_PATH,DIV_NAME,VACATION
FROM EMPLOYEE
