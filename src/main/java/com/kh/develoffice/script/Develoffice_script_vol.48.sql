...
select m.mail_num, mail_title, mail_content, d.emp_id, e.emp_name as "from_emp", mail_from, e2.emp_name as "to_emp", e3.emp_name as "cc_emp", mail_to, mail_cc, original_filename, rename_filename, mail_date, mail_important
from mail m
