...
ALTER TABLE "PROJECT_REPLY" ADD CONSTRAINT "FK_PROJECT_TASK_TO_PROJECT_REPLY_1" FOREIGN KEY ("TASK_NO")
...
select s_no, start_date, start_time, end_date, end_time, emp_id, emp_name || ' ' || job_name as emp_name, create_date, s_title, s_content, s_type, s_plan, dept_code, all_day
from schedule
join employee using(emp_id)
join job using(job_code)
join department using(dept_code)
