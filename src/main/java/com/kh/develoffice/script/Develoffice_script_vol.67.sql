...
AS
SELECT FREE_NO,FREE_TITLE,FREE_WRITER,EMP_NAME AS EMPNAME,FREE_CONTENT,F_ORIGINAL_FILENAME,F_RENAME_FILENAME,FREE_COUNT,F_CREATE_DATE,F_MODIFY_DATE,F.STATUS,FREE_LIKE_COUNT
...
AS
SELECT TB_NO,TB_TITLE,TB_WRITER,D.DEPT_CODE,EMP_NAME AS EMPNAME,TB_CONTENT,TB_ORIGINAL_FILENAME,TB_RENAME_FILENAME,TB_COUNT,TB_CREATE_DATE,TB_MODIFY_DATE,T.STATUS
...
AS
SELECT NOTICE_NO,NOTICE_TITLE,NOTICE_WRITER,D.DEPT_CODE,EMP_NAME AS EMPNAME,NOTICE_CONTENT,NOTICE_ORIGINAL_FILENAME,NOTICE_RENAME_FILENAME,NOTICE_COUNT,NOTICE_CREATE_DATE,NOTICE_MODIFY_DATE,N.STATUS
